...
const ensureWorkspaceSettings = (workspaceId) => {
  if (!workspaceSettingsMap.has(workspaceId)) {
    workspaceSettingsMap.set(workspaceId, structuredClone(defaultSettings));
  }
  return workspaceSettingsMap.get(workspaceId);
};

export const getWorkspaceSettings = ensureWorkspaceSettings;
